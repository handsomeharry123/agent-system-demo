...
const frontendRoot = new URL('../../002.前端代码/', import.meta.url);
const storeSource = fs.readFileSync(new URL('src/pages/agent-center/smart/store.tsx', frontendRoot), 'utf8');
const formSource = fs.readFileSync(new URL('src/pages/agent-center/smart/SmartRegistrationForm.tsx', frontendRoot), 'utf8');
