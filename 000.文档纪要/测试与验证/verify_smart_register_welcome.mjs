...
const storeSource = fs.readFileSync('002.前端代码/src/pages/agent-center/smart/store.tsx', 'utf8');
const formSource = fs.readFileSync('002.前端代码/src/pages/agent-center/smart/SmartRegistrationForm.tsx', 'utf8');
