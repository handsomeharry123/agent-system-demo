  ...
  },
  {
    key: 'audit', title: '审计中心', children: [
      { key: 'audit:project', title: '项目审计（仅立项申报项目的科室具备权限）', children: [
        page('audit:project:all', '项目审计页', ['刷新', '模板下载', '批量导出', '上传材料', '补充材料', '查看详情']),
        page('audit:project:upload', '项目审计材料上传页', ['确认', '取消']),
        page('audit:project:detail', '项目审计详情页', ['返回项目列表', '预览', '下载', '删除']),
      ] },
