...
import FunctionalPermissionRoute from './components/FunctionalPermissionRoute';
...
const routes: RouteObject[] = [
  ...
  // Platform routes with BasicLayout (protected)
  {
    ...
    children: [
      ...
      {
        path: 'user-center',
        element: <FunctionalPermissionRoute moduleKey="user" />,
        children: [
      ...
      // Audit
      {
        path: 'audit',
        children: [
          { index: true, element: <Navigate to="/app/audit/logs" replace /> },
          { path: 'economic', element: <Navigate to="/app/audit/logs" replace /> },
