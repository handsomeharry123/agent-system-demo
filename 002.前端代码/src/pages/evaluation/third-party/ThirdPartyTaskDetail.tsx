...
export default function ThirdPartyTaskDetail() {
  ...
  const chartColors = ['#52B788', '#52c41a', '#fa8c16', '#722ed1', '#13c2c2', '#eb2f96', '#2f54eb'];
