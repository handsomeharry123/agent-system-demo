...
const registerWindowCopy =
  '你好！我是医小知。点击【新建注册】，把产品说明书 / 技术规格书发给我（支持 PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮你自动识别并填表～';
...
const WELCOME_GREETINGS: Record<WelcomePageKey, Record<WelcomeRole, WelcomeCopy>> = {
  'project-application-pending': {
    dept: {
      bubble: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
      window: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
    },
    provider: {
      bubble: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
      window: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
    ...
    admin: {
      bubble: '您好，我是医小知。目前立项信息待审核X项，要进行立项信息审核吗？',
      window: '您好，我是医小知。目前立项信息待审核X项，要进行立项信息审核吗？',
    },
  },
  'project-application-reviewing': {
    dept: {
      bubble: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
      window: '您好，我是医小知。目前立项申报审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。',
    },
    provider: {
      bubble: '您好，我是医小知。目前立项申报待审核X项，我会帮你盯进度，有审核结果第一时间提醒你。',
      window: '您好，我是医小知。目前立项申报审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。',
  ...
  'project-application-revoked': {
    dept: {
      bubble: '您好，我是医小知。目前立项申报撤销修改X项，需要查看相关详情信息',
      window: '您好，我是医小知。目前立项申报撤销修改X项，需要查看相关详情信息',
    },
    provider: {
      bubble: '您好，我是医小知。目前立项申报撤销修改X项，需要查看相关详情信息',
      window: '您好，我是医小知。目前立项申报撤销修改X项，需要查看相关详情信息',
  ...
  'project-application-rejected': {
    dept: {
      bubble: '您好，我是医小知。目前立项申报立项不通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前立项申报立项不通过X项，需要查看相关详情信息吗？',
    },
    provider: {
      bubble: '您好，我是医小知。目前立项申报立项不通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前立项申报立项不通过X项，需要查看相关详情信息吗？',
  ...
  'project-application-passed': {
    dept: {
      bubble: '您好，我是医小知。目前立项申报立项通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前立项申报立项通过X项，需要查看相关详情信息吗？',
    },
    provider: {
      bubble: '您好，我是医小知。目前立项申报立项通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前立项申报立项通过X项，需要查看相关详情信息吗？',
  ...
  'project-application-all': {
    dept: {
      bubble: '您好，我是医小知。当前已申请立项X个项目（待审核X项、立项通过X项、立项不通过X项），在气泡里点对应状态即可直接进入处理～',
      window: '您好！我是医小知。您想要申报什么项目？点击【立项申报】，把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
    },
    provider: {
      bubble: '您好，我是医小知。当前已申请立项X个项目（待审核X项、立项通过X项、立项不通过X项），在气泡里点对应状态即可直接进入处理～',
      window: '您好！我是医小知。您想要申报什么项目？点击【立项申报】，把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
  ...
  'project-application-form': {
    dept: {
      bubble: '您好！我是医小知。您想要申报什么项目？把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
      window: '您好！我是医小知。您想要申报什么项目？把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
    },
    provider: {
      bubble: '您好！我是医小知。您想要申报什么项目？把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
      window: '您好！我是医小知。您想要申报什么项目？把项目申报书发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您申报项目~',
  ...
  'project-application-detail': {
    dept: {
      bubble: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~该项目已立项通过，是否需要我帮您填写接入注册信息？',
      window: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~该项目已立项通过，是否需要我帮您填写接入注册信息？',
    },
    provider: {
      bubble: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~',
      window: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~',
    },
    admin: {
      bubble: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~该项目已立项通过，是否需要我帮您填写接入注册信息？',
      window: '您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~该项目已立项通过，是否需要我帮您填写接入注册信息？',
  ...
  'project-application-audit': {
    dept: {
      bubble: '您好，我是医小知。我已完成预审：您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。',
      window: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。',
    },
    provider: {
      bubble: '您好，我是医小知。我已完成预审：您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。',
      window: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。',
  ...
  'audit-project-all': {
    dept: {
      bubble: '您好，我是医小知。当前待申请审计X个项目，点击【项目审计信息填报】，把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~',
      window: '您好，我是医小知。当前待申请审计X个项目，点击【项目审计信息填报】，把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~',
    },
    provider: {
      bubble: '您好，我是医小知。当前待申请审计X个项目，点击【项目审计信息填报】，把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~',
      window: '您好，我是医小知。当前待申请审计X个项目，点击【项目审计信息填报】，把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~',
  ...
  'audit-project-form': {
    dept: {
      bubble: '您好！我是医小知。把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~【上传文件】【语音描述】',
      window: '您好！我是医小知。把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~【上传文件】【语音描述】',
    },
    provider: {
      bubble: '您好！我是医小知。把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~【上传文件】【语音描述】',
      window: '您好！我是医小知。把相关证明材料发给我（支持PDF、DOC、DOCX等文件格式），或文字、语音描述，我来帮您填写项目审计信息~【上传文件】【语音描述】',
  ...
  'audit-project-draft': {
    dept: {
      bubble: '您好！我是医小知，您还有X条未完成的项目审计信息填报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的项目审计信息填报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
    },
    provider: {
      bubble: '您好！我是医小知，您还有X条未完成的项目审计信息填报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的项目审计信息填报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
  ...
  'audit-project-pending': {
    dept: {
      bubble: '您好，我是医小知。目前项目信息待审计X项，要进行项目审计吗？',
      window: '您好，我是医小知。目前项目审计信息待审计X项，要进行项目审计吗？',
    },
    provider: {
      bubble: '您好，我是医小知。目前项目信息待审计X项，要进行项目审计吗？',
      window: '您好，我是医小知。目前项目审计信息待审计X项，要进行项目审计吗？',
  ...
  'audit-project-reviewing': {
    dept: {
      bubble: '您好，我是医小知。目前项目信息审计中X项，我会帮你盯进度，有审计结果第一时间提醒你。',
      window: '您好，我是医小知。目前项目信息审计中X项，我会帮你盯进度，有审计结果第一时间提醒你。',
    },
    provider: {
      bubble: '您好，我是医小知。目前项目信息审计中X项，我会帮你盯进度，有审计结果第一时间提醒你。',
      window: '您好，我是医小知。目前项目信息审计中X项，我会帮你盯进度，有审计结果第一时间提醒你。',
  ...
  'audit-project-revoked': {
    dept: {
      bubble: '您好，我是医小知。目前项目审计信息填报撤销修改X项，需要我帮你快速修改后重新提交吗？',
      window: '您好，我是医小知。目前项目审计信息填报撤销修改X项，需要我帮你快速修改后重新提交吗？点开任意撤销修改列表项，我帮您快速修改。',
    },
    provider: {
      bubble: '您好，我是医小知。目前项目审计信息填报撤销修改X项，需要我帮你快速修改后重新提交吗？',
      window: '您好，我是医小知。目前项目审计信息填报撤销修改X项，需要我帮你快速修改后重新提交吗？点开任意撤销修改列表项，我帮您快速修改。',
  ...
  'audit-project-passed': {
    dept: {
      bubble: '您好，我是医小知。目前项目审计通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前项目审计通过X项，需要查看相关详情信息吗？',
    },
    provider: {
      bubble: '您好，我是医小知。目前项目审计通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前项目审计通过X项，需要查看相关详情信息吗？',
  ...
  'audit-project-rejected': {
    dept: {
      bubble: '您好，我是医小知。目前项目审计不通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前项目审计不通过X项，需要查看相关详情信息吗？',
    },
    provider: {
      bubble: '您好，我是医小知。目前项目审计不通过X项，需要查看相关详情信息吗？',
      window: '您好，我是医小知。目前项目审计不通过X项，需要查看相关详情信息吗？',
  ...
  'audit-project-detail': {
    dept: {
      bubble: '您好，我是医小知。您好，我是医小知。当前为您展示【X】的项目审计信息详情，有什么该项目相关问题可以直接问我~',
      window: '您好，我是医小知。您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~',
    },
    provider: {
      bubble: '您好，我是医小知。您好，我是医小知。当前为您展示【X】的项目审计信息详情，有什么该项目相关问题可以直接问我~',
      window: '您好，我是医小知。您好，我是医小知。当前为您展示【X】的立项信息详情，有什么该项目相关问题可以直接问我~',
  ...
  'audit-project-audit': {
    dept: {
      bubble: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审计参考，最终以你的决策为准。',
      window: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审计参考，最终以你的决策为准。',
    },
    provider: {
      bubble: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审计参考，最终以你的决策为准。',
      window: '您好，我是医小知。我已完成预审：标注了X个疑似问题，预审结论为「XX」，供你二次审计参考，最终以你的决策为准。',
  ...
  'agent-center-eval-offer': {
    dept: { bubble: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？', window: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？' },
    provider: { bubble: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？', window: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？' },
    admin: { bubble: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？', window: '您好，我是医小知。当前为您展示【X】的注册信息详情，有什么该智能体相关问题可以直接问我~该智能体已成功接入，是否需要立即创建安全性评测任务？' },
  },
  ...
  'monitoring-overview': {
    dept: { bubble: '您好！我是医小知，有什么运行监控信息都可以问我', window: '您好！我是医小知，本科室智能体累计告警X次，今日告警X次，待处理X项，有什么运行监控信息都可以问我' },
    provider: { bubble: '您好！我是医小知，有什么运行监控信息都可以问我', window: '您好！我是医小知，本科室智能体累计告警X次，今日告警X次，待处理X项，有什么运行监控信息都可以问我' },
    admin: { bubble: '您好！我是医小知，有什么运行监控信息都可以问我', window: '您好！我是医小知，全院智能体累计告警X次，今日告警X次，待处理X项，有什么运行监控信息都可以问我' },
  },
  'monitoring-business': {
    dept: { bubble: '您好！我是医小知，有什么业务监控相关信息都可以问我', window: '您好！我是医小知，本科室智能体累计调用X次、今日调用X次、调用成功率为X%，有什么业务监控相关信息都可以问我' },
    provider: { bubble: '您好！我是医小知，有什么业务监控相关信息都可以问我', window: '您好！我是医小知，本科室智能体累计调用X次、今日调用X次、调用成功率为X%，有什么业务监控相关信息都可以问我' },
    admin: { bubble: '您好！我是医小知，有什么业务监控相关信息都可以问我', window: '您好！我是医小知，全院智能体累计调用X次、今日调用X次、调用成功率为X%，有什么业务监控相关信息都可以问我' },
  },
  'monitoring-status': {
    dept: { bubble: '您好！我是医小知，有什么状态监控相关信息都可以问我', window: '您好！我是医小知，目前在线本科室智能体X个、离线X个、异常X个，有什么状态监控相关信息都可以问我' },
    provider: { bubble: '您好！我是医小知，有什么状态监控相关信息都可以问我', window: '您好！我是医小知，目前在线本科室智能体X个、离线X个、异常X个，有什么状态监控相关信息都可以问我' },
    admin: { bubble: '您好！我是医小知，有什么状态监控相关信息都可以问我', window: '您好！我是医小知，目前在线全院智能体X个、离线X个、异常X个，有什么状态监控相关信息都可以问我' },
  },
  'monitoring-cost': {
    dept: { bubble: '您好！我是医小知，有什么成本监控相关信息都可以问我', window: '您好！我是医小知，本科室智能体累计CPU使用量X核·时、GPU使用量X卡·时、内存使用量X GB·时、Token使用量X tokens，有什么成本监控相关信息都可以问我' },
    provider: { bubble: '您好！我是医小知，有什么成本监控相关信息都可以问我', window: '您好！我是医小知，本科室智能体累计CPU使用量X核·时、GPU使用量X卡·时、内存使用量X GB·时、Token使用量X tokens，有什么成本监控相关信息都可以问我' },
    admin: { bubble: '您好！我是医小知，有什么成本监控相关信息都可以问我', window: '您好！我是医小知，全院智能体累计CPU使用量X核·时、GPU使用量X卡·时、内存使用量X GB·时、Token使用量X tokens，有什么成本监控相关信息都可以问我' },
  },
  'monitoring-alert-rules': {
    dept: { bubble: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您', window: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您' },
    provider: { bubble: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您', window: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您' },
    admin: { bubble: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您', window: '您好！我是医小知，目前有X条告警规则，您想要了解什么告警规则，只需要文字或语音描述，我将直接告诉您' },
  },
  'monitoring-alert-events': {
    dept: { bubble: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～', window: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～' },
    provider: { bubble: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～', window: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～' },
    admin: { bubble: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～', window: '您好！我是医小知，目前告警事件X项、待处理X项、待审核X项，在气泡里点对应状态即可直接进入处理～' },
  },
  'monitoring-alert-pending-assign': {
    dept: { bubble: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~', window: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~' },
    provider: { bubble: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~', window: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~' },
    admin: { bubble: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~', window: '您好！我是医小知，目前告警事件待处理X项，您可文字或语音直接告诉我分派对象，我将自动帮您分派~' },
  },
  'monitoring-alert-detail': {
    dept: { bubble: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我', window: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我' },
    provider: { bubble: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我', window: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我' },
    admin: { bubble: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我', window: '您好！我是医小知，这是【X】的详情信息，有什么告警事件相关信息都可以问我' },
  },
  'monitoring-alert-review': {
    dept: { bubble: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。' },
    provider: { bubble: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。' },
    admin: { bubble: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。我已完成预审：预审结论为「XX」，供你二次审核参考，最终以你的决策为准。' },
  },
  'monitoring-alert-pending': {
    dept: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件待处理X项，您需要处理哪项告警事件，文字、语音告诉我，我直接帮您找到~' },
    provider: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件待处理X项，您需要处理哪项告警事件，文字、语音告诉我，我直接帮您找到~' },
    admin: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件待处理X项，您需要处理哪项告警事件，文字、语音告诉我，我直接帮您找到~' },
  },
  'monitoring-alert-handling': {
    dept: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件处理中X项～' },
    provider: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件处理中X项～' },
    admin: { bubble: '您好！我是医小知，目前告警事件待处理X项～', window: '您好！我是医小知，目前告警事件处理中X项～' },
  },
  'monitoring-alert-pending-review': {
    dept: { bubble: '您好！我是医小知，目前告警事件待审核X项～', window: '您好！我是医小知，目前告警事件待审核X项，您需要审核哪项已处理告警事件，文字、语音告诉我，我直接帮您找到~' },
    provider: { bubble: '您好！我是医小知，目前告警事件待审核X项～', window: '您好！我是医小知，目前告警事件待审核X项，您需要审核哪项已处理告警事件，文字、语音告诉我，我直接帮您找到~' },
    admin: { bubble: '您好！我是医小知，目前告警事件待审核X项～', window: '您好！我是医小知，目前告警事件待审核X项，您需要审核哪项已处理告警事件，文字、语音告诉我，我直接帮您找到~' },
  },
  'monitoring-alert-reviewing': {
    dept: { bubble: '您好！我是医小知，目前告警事件审核中X项～', window: '您好！我是医小知，目前告警事件审核中X项，您可以通过文字或语音告诉我要查看哪项事件，我将直接为您打开详情页。' },
    provider: { bubble: '您好！我是医小知，目前告警事件审核中X项～', window: '您好！我是医小知，目前告警事件审核中X项，您可以通过文字或语音告诉我要查看哪项事件，我将直接为您打开详情页。' },
    admin: { bubble: '您好！我是医小知，目前告警事件审核中X项～', window: '您好！我是医小知，目前告警事件审核中X项，您语音或文字将审核结论和原因说明告诉我，我将直接为您完成审核操作' },
  },
  'monitoring-alert-closed': {
    dept: { bubble: '您好！我是医小知，目前已关闭告警事件X项～', window: '您好！我是医小知，目前已关闭告警事件X项，是否需要查看详情？' },
    provider: { bubble: '您好！我是医小知，目前已关闭告警事件X项～', window: '您好！我是医小知，目前已关闭告警事件X项，是否需要查看详情？' },
    admin: { bubble: '您好！我是医小知，目前已关闭告警事件X项～', window: '您好！我是医小知，目前已关闭告警事件X项，是否需要查看详情？' },
  },
  'monitoring-alert-ignored': {
    dept: { bubble: '您好！我是医小知，目前已忽略告警事件X项～', window: '您好！我是医小知，目前已忽略告警事件X项，是否需要查看详情？' },
    provider: { bubble: '您好！我是医小知，目前已忽略告警事件X项～', window: '您好！我是医小知，目前已忽略告警事件X项，是否需要查看详情？' },
    admin: { bubble: '您好！我是医小知，目前已忽略告警事件X项～', window: '您好！我是医小知，目前已忽略告警事件X项，是否需要查看详情？' },
  },
  'evaluation-tasks': {
    dept: { bubble: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    provider: { bubble: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    admin: { bubble: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  'evaluation-create': {
    dept: { bubble: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    provider: { bubble: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。全院已接入X个智能体，安全性评测中X个、评测完成X个、审核中X个、审核通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  ...
  'pujiang-evaluation-tasks': {
    dept: { bubble: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    provider: { bubble: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    admin: { bubble: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。medbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  'cp-env-evaluation-tasks': {
    dept: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    provider: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    admin: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  'medagentbench-evaluation-tasks': {
    dept: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    provider: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
    admin: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  ...
  'cp-env-evaluation-create': {
    dept: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' }, provider: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' }, admin: { bubble: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。CP-Env评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  'medagentbench-evaluation-create': {
    dept: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' }, provider: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' }, admin: { bubble: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情', window: '您好，我是医小知。MedAgentbench评测中X个、评测通过X个、退回修改X个，在气泡里点对应状态即可直接分类查看详情' },
  },
  'evaluation-report': {
    dept: { bubble: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~' },
    provider: { bubble: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~' },
    admin: { bubble: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~该智能体已通过安全性评测，是否需要立即开展浦江实验室评测？', window: '您好，我是医小知。当前为您展示【X】的安全性评测结果详情，有什么安全性评测结果相关问题可以直接问我~该智能体已通过安全性评测，是否需要立即开展浦江实验室评测？' },
  },
  'pujiang-evaluation-report': {
    dept: { bubble: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~' }, provider: { bubble: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~' }, admin: { bubble: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的medbench评测结果详情，有什么评测结果相关问题可以直接问我~' },
  },
  'cp-env-evaluation-report': { dept:{bubble:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~'},provider:{bubble:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~'},admin:{bubble:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的CP-Env评测结果详情，有什么评测结果相关问题可以直接问我~'} },
  'medagentbench-evaluation-report': { dept:{bubble:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~'},provider:{bubble:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~'},admin:{bubble:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~',window:'您好，我是医小知。当前为您展示【X】的MedAgentbench评测结果详情，有什么评测结果相关问题可以直接问我~'} },
  'resource-approval': {
    dept: { bubble: '您好，我是医小知。我已完成预审：标注了X个疑似问题并跑了访问测试，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
    provider: { bubble: '您好，我是医小知。我已完成预审：标注了X个疑似问题并跑了访问测试，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
    admin: { bubble: '您好，我是医小知。我已完成预审：标注了X个疑似问题并跑了访问测试，预审结论为「XX」，供你二次审核参考，最终以你的决策为准。', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
  },
  'resource-apply-detail': {
    dept: { bubble: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
    provider: { bubble: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
    admin: { bubble: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~', window: '您好，我是医小知。当前为您展示【X】的信息详情，有什么资源相关问题可以直接问我~' },
  },
  'resource-apply-rejected': {
    dept: { bubble: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？' },
    provider: { bubble: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？' },
    admin: { bubble: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请退回修改X项，需要查看相关详情信息吗？' },
  },
  'resource-apply-approved': {
    dept: { bubble: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？' },
    provider: { bubble: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？' },
    admin: { bubble: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？', window: '您好，我是医小知。目前资源申请审核通过X项，需要查看相关详情信息吗？' },
  },
  'resource-apply-revoked': {
    dept: { bubble: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？', window: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？点开任意撤销修改列表项，我帮您快速修改。' },
    provider: { bubble: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？', window: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？点开任意撤销修改列表项，我帮您快速修改。' },
    admin: { bubble: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？', window: '您好，我是医小知。目前资源申请撤销修改X项，需要我帮你快速修改后重新提交吗？点开任意撤销修改列表项，我帮您快速修改。' },
  },
  'resource-apply-pending': {
    dept: { bubble: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？', window: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？' },
    provider: { bubble: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？', window: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？' },
    admin: { bubble: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？', window: '您好，我是医小知。目前资源申请待审核X项，要进行资源申请审核吗？' },
  },
  'resource-apply-reviewing': {
    dept: { bubble: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。', window: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。' },
    provider: { bubble: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。', window: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。' },
    admin: { bubble: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。', window: '您好，我是医小知。目前资源申请审核中X项，我会帮你盯进度，有审核结果第一时间提醒你。' },
  },
  'resource-apply-draft': {
    dept: { bubble: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。', window: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。' },
    provider: { bubble: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。', window: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。' },
    admin: { bubble: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。', window: '您好，我是医小知。您还有X条未完成的资源申请草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。' },
  },
  'resource-apply-all': {
    dept: { bubble: '您好，我是医小知。目前已申请X项资源，您需要申请什么资源？', window: '您好，我是医小知。您需要申请什么资源？点击【权限申请】，文字、语音描述，我来帮您申请~' },
    provider: { bubble: '您好，我是医小知。目前已申请X项资源，您需要申请什么资源？', window: '您好，我是医小知。您需要申请什么资源？点击【权限申请】，文字、语音描述，我来帮您申请~' },
    admin: { bubble: '您好，我是医小知。目前已申请X项资源，您需要申请什么资源？', window: '您好，我是医小知。您需要申请什么资源？点击【权限申请】，文字、语音描述，我来帮您申请~' },
  },
  'resource-apply-form': {
    dept: { bubble: '您好，我是医小知。请通过文字或语音描述要为哪个智能体申请什么资源，我来帮您填写权限申请。', window: '您好，我是医小知。请告诉我要为哪个智能体申请什么资源，您也可以继续补充申请理由，我来帮您填写~' },
    provider: { bubble: '您好，我是医小知。请通过文字或语音描述要为哪个智能体申请什么资源，我来帮您填写权限申请。', window: '您好，我是医小知。请告诉我要为哪个智能体申请什么资源，您也可以继续补充申请理由，我来帮您填写~' },
    admin: { bubble: '您好，我是医小知。请通过文字或语音描述要为哪个智能体申请什么资源，我来帮您填写权限申请。', window: '您好，我是医小知。请告诉我要为哪个智能体申请什么资源，您也可以继续补充申请理由，我来帮您填写~' },
  },
  'resource-center-register': {
    dept: {
      bubble: '您好！我是医小知。您需要注册什么资源？点击【上传文件】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
      window: '您好！我是医小知。您需要注册什么资源？点击【上传文件】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
    },
    provider: {
      bubble: '您好！我是医小知。您需要注册什么资源？点击【上传文件】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
      window: '您好！我是医小知。您需要注册什么资源？点击【上传文件】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
  ...
  'resource-center-draft': {
    dept: {
      bubble: '您好！我是医小知，您还有X条未完成的资源注册草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的资源注册草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
    },
    provider: {
      bubble: '您好！我是医小知，您还有X条未完成的资源注册草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的资源注册草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
  ...
  'resource-center-all': {
    dept: {
      bubble: '您好，我是医小知。当前已注册X项资源，您需要注册什么资源吗？',
      window: '您您好！我是医小知。您需要注册什么资源？点击【注册资源】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
    },
    provider: {
      bubble: '您好，我是医小知。当前已注册X项资源，您需要注册什么资源吗？',
      window: '您您好！我是医小知。您需要注册什么资源？点击【注册资源】，把资源信息文档发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您注册~',
  ...
  'agent-needs-detail': {
    dept: {
      bubble: '您好，我是医小知。当前为您展示【X】的建设需求详情，由【X】提出，需求紧急程度为【X】。平台已完成智能体匹配，最高匹配度为X%。',
      window: '您好，我是医小知。当前为您展示【X】的建设需求详情，由【X】提出，需求紧急程度为【X】。平台已完成智能体匹配，最高匹配度为X%。',
    },
    provider: {
      bubble: '您好，我是医小知。当前为您展示【X】的建设需求详情，由【X】提出，需求紧急程度为【X】。平台已完成智能体匹配，最高匹配度为X%。',
      window: '您好，我是医小知。当前为您展示【X】的建设需求详情，由【X】提出，需求紧急程度为【X】。平台已完成智能体匹配，最高匹配度为X%。',
  ...
  'agent-needs-draft': {
    dept: {
      bubble: '您好！我是医小知，您还有 X 条未完成的需求登记草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有 X 条未完成的需求登记草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
    },
    provider: {
      bubble: '您好！我是医小知，您还有 X 条未完成的需求登记草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有 X 条未完成的需求登记草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
  ...
  'project-application-draft': {
    dept: {
      bubble: '您好！我是医小知，您还有X条未完成的立项申报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的立项申报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
    },
    provider: {
      bubble: '您好！我是医小知，您还有X条未完成的立项申报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
      window: '您好！我是医小知，您还有X条未完成的立项申报草稿，需要我帮您继续补全吗？点开任意草稿，我接着帮您填。',
  ...
  'agent-needs-list': {
    dept: {
      bubble: '您好，我是医小知。当前已登记 X 条建设需求（高优先级 X 条、中优先级 X 条、低优先级 X 条），点击对应分类查看需求详情。',
      window: '您好！我是医小知。您想要建设什么智能体？点击【生成需求】，把需求文档说明发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您登记需求~',
    },
    provider: {
      bubble: '您好，我是医小知。当前已登记 X 条建设需求（高优先级 X 条、中优先级 X 条、低优先级 X 条），点击对应分类查看需求详情。',
      window: '您好！我是医小知。您想要建设什么智能体？点击【生成需求】，把需求文档说明发给我（支持PDF、DOC、DOCX、XLSX、csv、jpg、jpeg、png、链接等任意文件格式），或文字、语音描述，我来帮您登记需求~',
