...
export const dictionaries: Dictionary[] = [
  ['dept','科室',41],['clinical_stage','诊疗环节',9],['agent_source','智能体来源',3],['access_mode','接入方式',3],['test_sample_size','测试样本量',3],['alert_rule_type','告警规则类型',4],['organization','所属组织',42],['model_deployment_type','模型部署方式',3],
...
const samples: Record<string,[string,string][]> = {
  ...
  model_deployment_type:[['on_premises','本地化部署'],['cloud','云端部署'],['hybrid','混合部署']],
};
